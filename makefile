...
test: all
	@clear
	@../test/QtOvercooked.app/Contents/MacOS/QtOvercooked -l maps/level1/level1-1.txt -p build/main

run: all
	@clear
	@../test/QtOvercooked.app/Contents/MacOS/QtOvercooked -l maps/level1/level1-1.txt
